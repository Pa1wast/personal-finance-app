...
function SearchAndFilter({ categories }) {
  ...
  return (
    <div className="flex justify-between gap-6">
      <div
        ...
        className="group mr-auto flex max-w-[30%] flex-1 items-center justify-between rounded-lg border border-beige-500 focus-within:border-grey-900 hover:border-grey-900"
      >
        <input
